...
module.exports = (app) => {
    ...
    app.post('/category/add', auth.isInRole('Admin'), upload.array(), controllers.category.addPost)
    ...
    app.get('/user/register', controllers.user.addUserGet)
    app.post('/user/register', controllers.user.addUserPost)
